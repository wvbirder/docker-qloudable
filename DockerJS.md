...
**NOTE:** In this lab deployment the "database" product catalog is and bundled with the REST service. The product listing is provided via JSON. In the full blown deployment available as a follow-up lab Lab, you would use an Oracle or MYSQL database as the datasource.
